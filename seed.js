// Populate the database with Pokémon, items, etc. from the PokéAPI
...
//           )?.effect || 'Unknown',
//         spriteUrl:
//           itemDetails.sprites.default || 'https://via.placeholder.com/150',
...
//       const berryEffect =
//         berryDetailsResponse.data.flavor_text_entries.find(
//           (entry) => entry.language.name === 'en',
//         )?.text || 'Unknown';
...
//         `https://pokeapi.co/api/v2/item/${heldItemName}/`,
//       );
...
//         effect:
//           heldItemDetails.flavor_text_entries
...
//   const standardBallsResponse = await axios.get(
//     'https://pokeapi.co/api/v2/item-category/34',
//   );
//   const specialBallsResponse = await axios.get(
//     'https://pokeapi.co/api/v2/item-category/33',
//   );
//   const apricornBallsResponse = await axios.get(
//     'https://pokeapi.co/api/v2/item-category/39',
//   );
...
//       const ballEffect =
//         ballDetails.effect_entries.find((entry) => entry.language.name === 'en')
//           ?.effect || 'Unknown';
...
//         description:
//           ballDetails.flavor_text_entries
//             .find((entry) => entry.language.name === 'en')
//             ?.text.split('\n')
//             .join(' ') || 'Unknown',
//         spriteUrl:
//           ballDetails.sprites.default || 'https://via.placeholder.com/150',
...
//   const first100ItemsResponse = await axios.get(
...
//         const effectEntry = itemDetails.flavor_text_entries.find(
//           (entry) => entry.language.name === 'en',
//         );
//         const effect =
//           effectEntry && effectEntry.text
//             ? effectEntry.text.split('\n').join(' ')
//             : 'Unknown';
